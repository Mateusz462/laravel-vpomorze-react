		...
		<div class="col-12">
			<div class="card mb-4">
                ...
                <div class="tab-content" id="tab-content">
                    <div class="tab-pane fade show active" id="tabs-warsztat" role="tabpanel" aria-labelledby="tabs-warsztat">
                        <div class="card-body pb-0">
                            <div class="row">
        						<div class="col-md-12 col-lg-6">
                                    <div class="card border bg-dark mb-4">
                                        <div class="card-body">
        									<h3 class="font-weight-bold text-center"><i class="fas fa-clipboard"></i> Wnioski do Mechaników</h3>
                                            <br>
        						...
        						<div class="col-md-12 col-lg-6">
                                    <div class="card border bg-dark mb-4">
                                        <div class="card-body">
        									<h3 class="font-weight-bold text-center"><i class="fas fa-briefcase"></i> Tabor</h3>
                                            <br>
