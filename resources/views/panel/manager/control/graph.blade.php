...
@section('content')
    <div class="row">
        <div id="vztm-graph"></div>
        <div class="col-12 mt-3">
            <div class="row mb-4">
                <p>
                    <i class="fas fa-square text-blue fa-lg me-2"></i>Zwykła służba &nbsp; &nbsp;
                    <i class="fas fa-square text-purple fa-lg me-2"></i>Kurs z Wolnego &nbsp; &nbsp;
                    <i class="fas fa-square text-orange fa-lg me-2"></i>Rezerwa &nbsp; &nbsp;
                    <i class="fas fa-square text-brown fa-lg me-2"></i>Rezerwa z Kurs z Wolnego 
                    &nbsp; &nbsp;●&nbsp; &nbsp;
                    ...
                    <i class="fas fa-square text-secondary fa-lg me-2"></i>Kurs anulowany
                </p>
                <p>
