        ...
        <div class="container-fluid px-4 my-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Ogłoszenia</li>
                </ol>
            </nav>
            <nav aria-label="breadcrumb">
                <div class="breadcrumb-menu dropdown me-3 me-lg-1">
					...
					<ul class="dropdown-menu dropdown-menu-start dropdown-menu-lg-end" aria-labelledby="navbarDropdownMenuLink">
                        <a class="dropdown-item" href="{{ route('manager.management.ogloszenia.create') }}">Stwórz Ogłoszenie</a>
				...
				<div class="card-body">
                    <div class="row">
                        ...
                        <div class="col text-end">
                            <a href="{{ route('manager.management.ogloszenia.tags.index') }}" class="btn btn-outline-info"><i class="fas fa-tags"></i> Etykiety</a>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group btn-group-sm" role="group" aria-label="Basic example">
                                                        <a href="{{ route('ogloszenia.show', $row->id)}}" class="btn btn-primary"><i class="fas fa-eye"></i></a>
                                                        <a href="{{ route('manager.management.ogloszenia.edit', $row->id) }}" class="btn btn-info"><i class="far fa-edit"></i></a>
